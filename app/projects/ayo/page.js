    ...
    <main className="section-y-spacing">
      ...
      <section className="w-full h-fit grid-margin-px overflow-hidden">
        ...
        <div className="w-full h-fit flex">
          <div className="h-fit tablet:w-1/2 w-full space-y-[300px] grid-gutter-pr" id="ayo__scroll__animation-div">
            <div>
          ...
          <div className="tablet:w-1/2 w-0 grid-gutter-pl relative tablet:flex hidden" style={{
